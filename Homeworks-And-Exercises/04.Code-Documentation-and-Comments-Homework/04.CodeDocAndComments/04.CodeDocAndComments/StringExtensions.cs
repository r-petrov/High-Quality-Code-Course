...
/// <summary>
/// This class manipulates in different ways and receives different results from user's string input according to the purpose of this input.
/// </summary>
public static class StringExtensions
{
    /// <summary>
    /// Computes the hash value for the specified byte array derived from entered by the user password.
    /// </summary>
    /// <param name="input">The password, entered by the user as a string, which is being hashed.</param>
    /// <returns>The hash value as a string of the password entered by the user.</returns>
